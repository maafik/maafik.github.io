...
function t_forms__sendToTelegram(data, btnSubmit) {
    var apiToken = "YOUR_TELEGRAM_BOT_API_TOKEN";  // Ваш токен Telegram
    var chatId = "YOUR_CHAT_ID";  // Ваш ID чата
